...
Mesa is released as `OpenStepMesa342Libraries.pkg`,
`OpenStepMesa342Headers.pkg` and `OpenStepMesa342Demos.pkg`. Every release commit must include their `.info`
...
All packages carry a separate tiny i386 Mach-O marker. The Headers package
